...
def main() -> None:
    ...
    generated_image_path = generate_preview(args.ep, scene_id=scene_id_int)
    ...
    generate_scene_animation(args.ep, scene_id, image_path_override=str(generated_image_path))
